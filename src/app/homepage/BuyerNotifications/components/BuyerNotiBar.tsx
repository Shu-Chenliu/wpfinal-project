    ...
    <>
      ...
      <div className="px-4">
        <div className="mb-4 ">
          ...
          <p className="flex w-full font-semibold text-slate-900"> Product number: {number}</p>
          <p className="flex w-full font-semibold text-slate-900"> Product Seller: {author} </p>
        </div>
      </div>
